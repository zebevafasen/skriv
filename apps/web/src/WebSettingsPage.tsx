  ...
  return (
    <section className="settings-card">
      <div>
        ...
        <h2>Invitations and account</h2>
        <p>Invite another private-beta user or end this browser session.</p>
      </div>
      <div className="credential-input-row">
        ...
        <button
          ...
          disabled={!email}
          onClick={() =>
            void inviteRequest<Invite>("/api/invites", {
              method: "POST",
        ...
        {invites.map((invite) => (
          <div key={invite.id}>
            ...
            <button
              ...
              onClick={() =>
                void inviteRequest(`/api/invites/${invite.id}`, { method: "DELETE" }).then(refresh)
              }
            >
              <Trash2 size={15} />
            </button>
      ...
      <button
        ...
        className="button ghost"
        onClick={() =>
          void fetch("/api/auth/sign-out", { method: "POST", credentials: "include" }).finally(() =>
